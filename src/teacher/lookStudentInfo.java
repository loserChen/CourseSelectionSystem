...
import teacher.DBJavaBean;
import teacher.Student;

/**
 * Servlet implementation class lookStudentInfo
 */
@WebServlet("/lookStudentInfo")
public class lookStudentInfo extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public lookStudentInfo() {
        super();
