...
public class AddTeacherServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(db.addTeacher(teacherNumber, teacherName, teacherSex, teacherPassword))
		{
			response.sendRedirect("/CourseSelectSystem/Admin/teacherManage/message1.jsp");
		}
		else
		{
			response.sendRedirect("/CourseSelectSystem/Admin/teacherMannage/addTeacher.jsp");
		}
	}
