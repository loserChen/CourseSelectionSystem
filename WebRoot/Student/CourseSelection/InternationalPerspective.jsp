...
String sql="select * from Courses,Teachers,AvailableCourses where AvailableCourses.Cno like'CIP%' and AvailableCourses.Cno=Courses.Cno and AvailableCourses.Tno=Teachers.Tno";
