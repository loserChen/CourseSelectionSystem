...
String sql="select * from Courses,Teachers,AvailableCourses where AvailableCourses.Cno like 'CSR%' and AvailableCourses.Cno=Courses.Cno and AvailableCourses.Tno=Teachers.Tno";
