...
//String sql="select Reports.* from Reports,Courses where Courses.Cno=Reports.Cno and Courses.Csemester='"+semester+"'";
//+"and Reports.Sno='"+username+"'";
